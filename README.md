...
In a hurry? The one-screen operator cheat sheet: [QUICK_START.md](QUICK_START.md). Check the framework is consistent any time: `python3 tools/amf-lint.py`.
...
| 1.0.1 | 2026-07-16 | Architect (AI), v1.1.0 | Surfaced QUICK_START and amf-lint |
